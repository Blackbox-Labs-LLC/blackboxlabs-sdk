...
export const wsPlaceholderQueryKey = (options: Options<WsPlaceholderData>) => createQueryKey('wsPlaceholder', options);

export const wsPlaceholderOptions = (options: Options<WsPlaceholderData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await wsPlaceholder({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: wsPlaceholderQueryKey(options)
    });
};
