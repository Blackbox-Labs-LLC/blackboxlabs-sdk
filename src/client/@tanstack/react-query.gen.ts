...
import { type Options, changePassword, disable2Fa, enable2Fa, login, logout, register, requestPasswordReset, resetPassword, listSessions, revokeAllSessions, revokeSession, extendSession, setup2Fa, verifyEmail, getConfig, identifyContact, createTicketContact, getTicketContact, listMessagesContact, postMessageContact, listOrgs, createOrg, deleteOrg, getOrg, updateOrg, listMembers, addMember, removeMember, createAttachment, downloadAttachment, signUpload, listRoles, createRole, deleteRole, getRole, updateRole, assignRole, unassignRole, getOrgSettings, updateOrgSettings, listTickets, createTicket, getTicket, updateTicket, addTag, removeTag, listMessages, postMessage, listTags, listWatchers, addWatcher, removeWatcher, listApiKeys, createApiKey, deleteApiKey, getApiKey, revokeApiKey, uploadAvatar, getLoginAttempts, getLoginHistory, changePassword2, getProfile, updateProfile } from '../sdk.gen';
...
import type { ChangePasswordData, ChangePasswordError, Disable2FaData, Disable2FaError, Enable2FaData, Enable2FaError, LoginData, LoginError, LoginResponse, LogoutData, LogoutError, RegisterData, RegisterError, RegisterResponse, RequestPasswordResetData, RequestPasswordResetError, ResetPasswordData, ResetPasswordError, ListSessionsData, RevokeAllSessionsData, RevokeSessionData, ExtendSessionData, Setup2FaData, Setup2FaError, Setup2FaResponse2, VerifyEmailData, VerifyEmailError, GetConfigData, IdentifyContactData, IdentifyContactResponse2, CreateTicketContactData, CreateTicketContactResponse, GetTicketContactData, ListMessagesContactData, PostMessageContactData, PostMessageContactResponse, ListOrgsData, ListOrgsError, ListOrgsResponse2, CreateOrgData, CreateOrgResponse, DeleteOrgData, DeleteOrgError, GetOrgData, UpdateOrgData, UpdateOrgError, ListMembersData, AddMemberData, RemoveMemberData, CreateAttachmentData, CreateAttachmentError, CreateAttachmentResponse, DownloadAttachmentData, SignUploadData, SignUploadError, SignUploadResponse, ListRolesData, CreateRoleData, CreateRoleError, CreateRoleResponse, DeleteRoleData, DeleteRoleError, GetRoleData, UpdateRoleData, UpdateRoleError, UpdateRoleResponse, AssignRoleData, AssignRoleError, UnassignRoleData, UnassignRoleError, GetOrgSettingsData, UpdateOrgSettingsData, UpdateOrgSettingsError, ListTicketsData, ListTicketsResponse, CreateTicketData, CreateTicketError, CreateTicketResponse, GetTicketData, UpdateTicketData, UpdateTicketError, UpdateTicketResponse, AddTagData, AddTagError, RemoveTagData, ListMessagesData, PostMessageData, PostMessageError, PostMessageResponse, ListTagsData, ListWatchersData, AddWatcherData, RemoveWatcherData, ListApiKeysData, ListApiKeysError, ListApiKeysResponse, CreateApiKeyData, CreateApiKeyError, CreateApiKeyResponse2, DeleteApiKeyData, DeleteApiKeyError, GetApiKeyData, RevokeApiKeyData, RevokeApiKeyError, UploadAvatarData, UploadAvatarError, UploadAvatarResponse2, GetLoginAttemptsData, GetLoginHistoryData, ChangePassword2Data, ChangePassword2Error, GetProfileData, UpdateProfileData, UpdateProfileError, UpdateProfileResponse } from '../types.gen';
 ...
 * Disable 2FA for the user.
 */
export const disable2FaMutation = (options?: Partial<Options<Disable2FaData>>): UseMutationOptions<unknown, Disable2FaError, Options<Disable2FaData>> => {
    const mutationOptions: UseMutationOptions<unknown, Disable2FaError, Options<Disable2FaData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await disable2Fa({
                ...options,
                ...localOptions,
 ...
 * Confirm TOTP code to enable 2FA for the user.
 */
export const enable2FaMutation = (options?: Partial<Options<Enable2FaData>>): UseMutationOptions<unknown, Enable2FaError, Options<Enable2FaData>> => {
    const mutationOptions: UseMutationOptions<unknown, Enable2FaError, Options<Enable2FaData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await enable2Fa({
                ...options,
                ...localOptions,
 ...
 * Extend the session expiration by a number of days (owner only).
 */
export const extendSessionMutation = (options?: Partial<Options<ExtendSessionData>>): UseMutationOptions<unknown, DefaultError, Options<ExtendSessionData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<ExtendSessionData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await extendSession({
                ...options,
                ...localOptions,
 ...
 * Identify or create contact and issue token
 */
export const identifyContactMutation = (options?: Partial<Options<IdentifyContactData>>): UseMutationOptions<IdentifyContactResponse2, DefaultError, Options<IdentifyContactData>> => {
    const mutationOptions: UseMutationOptions<IdentifyContactResponse2, DefaultError, Options<IdentifyContactData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await identifyContact({
                ...options,
                ...localOptions,
 ...
 * Create a ticket on behalf of an identified contact. Requires Authorization: Bearer <contact_jwt>.
 */
export const createTicketContactMutation = (options?: Partial<Options<CreateTicketContactData>>): UseMutationOptions<CreateTicketContactResponse, DefaultError, Options<CreateTicketContactData>> => {
    const mutationOptions: UseMutationOptions<CreateTicketContactResponse, DefaultError, Options<CreateTicketContactData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createTicketContact({
                ...options,
                ...localOptions,
 ...
 * Post message (contact)
 */
export const postMessageContactMutation = (options?: Partial<Options<PostMessageContactData>>): UseMutationOptions<PostMessageContactResponse, DefaultError, Options<PostMessageContactData>> => {
    const mutationOptions: UseMutationOptions<PostMessageContactResponse, DefaultError, Options<PostMessageContactData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postMessageContact({
                ...options,
                ...localOptions,
...
export const listOrgsInfiniteOptions = (options: Options<ListOrgsData>) => {
    ...
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListOrgsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: listOrgsInfiniteQueryKey(options)
    });
};
 ...
 * Create organization
 */
export const createOrgMutation = (options?: Partial<Options<CreateOrgData>>): UseMutationOptions<CreateOrgResponse, DefaultError, Options<CreateOrgData>> => {
    const mutationOptions: UseMutationOptions<CreateOrgResponse, DefaultError, Options<CreateOrgData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createOrg({
                ...options,
                ...localOptions,
 ...
 */
export const updateOrgMutation = (options?: Partial<Options<UpdateOrgData>>): UseMutationOptions<unknown, UpdateOrgError, Options<UpdateOrgData>> => {
    const mutationOptions: UseMutationOptions<unknown, UpdateOrgError, Options<UpdateOrgData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Add organization member
 */
export const addMemberMutation = (options?: Partial<Options<AddMemberData>>): UseMutationOptions<unknown, DefaultError, Options<AddMemberData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<AddMemberData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await addMember({
                ...options,
                ...localOptions,
...
export const createAttachmentQueryKey = (options: Options<CreateAttachmentData>) => createQueryKey('createAttachment', options);
 ...
 * Generate a signed URL for direct file upload to storage. Requires MANAGE_ATTACHMENTS permission.
 */
export const signUploadMutation = (options?: Partial<Options<SignUploadData>>): UseMutationOptions<SignUploadResponse, SignUploadError, Options<SignUploadData>> => {
    const mutationOptions: UseMutationOptions<SignUploadResponse, SignUploadError, Options<SignUploadData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await signUpload({
                ...options,
                ...localOptions,
 ...
 * Assign a role to a user in an organization. Requires MANAGE_ROLES permission.
 */
export const assignRoleMutation = (options?: Partial<Options<AssignRoleData>>): UseMutationOptions<unknown, AssignRoleError, Options<AssignRoleData>> => {
    const mutationOptions: UseMutationOptions<unknown, AssignRoleError, Options<AssignRoleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await assignRole({
                ...options,
                ...localOptions,
...
export const unassignRoleQueryKey = (options: Options<UnassignRoleData>) => createQueryKey('unassignRole', options);

/**
 * Unassign role from user
 * Remove a role from a user in an organization. Requires MANAGE_ROLES permission.
 */
export const unassignRoleOptions = (options: Options<UnassignRoleData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: unassignRoleQueryKey(options)
    });
};
 ...
 * Remove a role from a user in an organization. Requires MANAGE_ROLES permission.
 */
export const unassignRoleMutation = (options?: Partial<Options<UnassignRoleData>>): UseMutationOptions<unknown, UnassignRoleError, Options<UnassignRoleData>> => {
    const mutationOptions: UseMutationOptions<unknown, UnassignRoleError, Options<UnassignRoleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await unassignRole({
                ...options,
                ...localOptions,
...
export const getOrgSettingsQueryKey = (options: Options<GetOrgSettingsData>) => createQueryKey('getOrgSettings', options);

/**
 * Get organization settings
 * Get organization settings. Requires member access.
 */
export const getOrgSettingsOptions = (options: Options<GetOrgSettingsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getOrgSettingsQueryKey(options)
    });
};
 ...
 */
export const updateOrgSettingsMutation = (options?: Partial<Options<UpdateOrgSettingsData>>): UseMutationOptions<unknown, UpdateOrgSettingsError, Options<UpdateOrgSettingsData>> => {
    const mutationOptions: UseMutationOptions<unknown, UpdateOrgSettingsError, Options<UpdateOrgSettingsData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Adds an existing tag by id or creates one by name within the ticket's organization.
 */
export const addTagMutation = (options?: Partial<Options<AddTagData>>): UseMutationOptions<unknown, AddTagError, Options<AddTagData>> => {
    const mutationOptions: UseMutationOptions<unknown, AddTagError, Options<AddTagData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await addTag({
                ...options,
                ...localOptions,
 ...
 */
export const removeTagMutation = (options?: Partial<Options<RemoveTagData>>): UseMutationOptions<unknown, DefaultError, Options<RemoveTagData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<RemoveTagData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Add ticket watcher
 */
export const addWatcherMutation = (options?: Partial<Options<AddWatcherData>>): UseMutationOptions<unknown, DefaultError, Options<AddWatcherData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<AddWatcherData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await addWatcher({
                ...options,
                ...localOptions,
 ...
 */
export const removeWatcherMutation = (options?: Partial<Options<RemoveWatcherData>>): UseMutationOptions<unknown, DefaultError, Options<RemoveWatcherData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<RemoveWatcherData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Generate a signed URL for uploading user avatar image. Only image files are allowed.
 */
export const uploadAvatarMutation = (options?: Partial<Options<UploadAvatarData>>): UseMutationOptions<UploadAvatarResponse2, UploadAvatarError, Options<UploadAvatarData>> => {
    const mutationOptions: UseMutationOptions<UploadAvatarResponse2, UploadAvatarError, Options<UploadAvatarData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await uploadAvatar({
                ...options,
                ...localOptions,
 ...
 */
export const changePassword2Mutation = (options?: Partial<Options<ChangePassword2Data>>): UseMutationOptions<unknown, ChangePassword2Error, Options<ChangePassword2Data>> => {
    const mutationOptions: UseMutationOptions<unknown, ChangePassword2Error, Options<ChangePassword2Data>> = {
        mutationFn: async (localOptions) => {
