 ...
 * Execute a self-serve action
 */
export const executeActionMutation = (options?: Partial<Options<ExecuteActionData>>): UseMutationOptions<ExecuteActionResponse, DefaultError, Options<ExecuteActionData>> => {
    const mutationOptions: UseMutationOptions<ExecuteActionResponse, DefaultError, Options<ExecuteActionData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await executeAction({
                ...options,
                ...localOptions,
 ...
 * Link typed resources to a user or ticket
 */
export const linkResourcesMutation = (options?: Partial<Options<LinkResourcesData>>): UseMutationOptions<LinkResourcesResponse2, DefaultError, Options<LinkResourcesData>> => {
    const mutationOptions: UseMutationOptions<LinkResourcesResponse2, DefaultError, Options<LinkResourcesData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await linkResources({
                ...options,
                ...localOptions,
 ...
 * Returns a URL (and optional form fields) to upload an attachment directly to storage.
 */
export const signUploadMutation = (options?: Partial<Options<SignUploadData>>): UseMutationOptions<SignUploadResponse, DefaultError, Options<SignUploadData>> => {
    const mutationOptions: UseMutationOptions<SignUploadResponse, DefaultError, Options<SignUploadData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await signUpload({
                ...options,
                ...localOptions,
