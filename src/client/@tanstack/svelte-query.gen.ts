 ...
 */
export const deleteOrgMutation = (options?: Partial<Options<DeleteOrgData>>): MutationOptions<unknown, DeleteOrgError, Options<DeleteOrgData>> => {
    const mutationOptions: MutationOptions<unknown, DeleteOrgError, Options<DeleteOrgData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateOrgMutation = (options?: Partial<Options<UpdateOrgData>>): MutationOptions<unknown, UpdateOrgError, Options<UpdateOrgData>> => {
    const mutationOptions: MutationOptions<unknown, UpdateOrgError, Options<UpdateOrgData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Finalize an uploaded file and create an attachment record. Requires MANAGE_ATTACHMENTS permission.
 */
export const createAttachmentMutation = (options?: Partial<Options<CreateAttachmentData>>): MutationOptions<CreateAttachmentResponse, CreateAttachmentError, Options<CreateAttachmentData>> => {
    const mutationOptions: MutationOptions<CreateAttachmentResponse, CreateAttachmentError, Options<CreateAttachmentData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createAttachment({
                ...options,
                ...localOptions,
 ...
 * Generate a signed URL for direct file upload to storage. Requires MANAGE_ATTACHMENTS permission.
 */
export const signUploadMutation = (options?: Partial<Options<SignUploadData>>): MutationOptions<SignUploadResponse, SignUploadError, Options<SignUploadData>> => {
    const mutationOptions: MutationOptions<SignUploadResponse, SignUploadError, Options<SignUploadData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await signUpload({
                ...options,
                ...localOptions,
 ...
 * Create a new role in an organization. Requires MANAGE_ROLES permission.
 */
export const createRoleMutation = (options?: Partial<Options<CreateRoleData>>): MutationOptions<CreateRoleResponse, CreateRoleError, Options<CreateRoleData>> => {
    const mutationOptions: MutationOptions<CreateRoleResponse, CreateRoleError, Options<CreateRoleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createRole({
                ...options,
                ...localOptions,
 ...
 */
export const deleteRoleMutation = (options?: Partial<Options<DeleteRoleData>>): MutationOptions<unknown, DeleteRoleError, Options<DeleteRoleData>> => {
    const mutationOptions: MutationOptions<unknown, DeleteRoleError, Options<DeleteRoleData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateRoleMutation = (options?: Partial<Options<UpdateRoleData>>): MutationOptions<UpdateRoleResponse, UpdateRoleError, Options<UpdateRoleData>> => {
    const mutationOptions: MutationOptions<UpdateRoleResponse, UpdateRoleError, Options<UpdateRoleData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Assign a role to a user in an organization. Requires MANAGE_ROLES permission.
 */
export const assignRoleMutation = (options?: Partial<Options<AssignRoleData>>): MutationOptions<unknown, AssignRoleError, Options<AssignRoleData>> => {
    const mutationOptions: MutationOptions<unknown, AssignRoleError, Options<AssignRoleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await assignRole({
                ...options,
                ...localOptions,
 ...
 * Remove a role from a user in an organization. Requires MANAGE_ROLES permission.
 */
export const unassignRoleMutation = (options?: Partial<Options<UnassignRoleData>>): MutationOptions<unknown, UnassignRoleError, Options<UnassignRoleData>> => {
    const mutationOptions: MutationOptions<unknown, UnassignRoleError, Options<UnassignRoleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await unassignRole({
                ...options,
                ...localOptions,
 ...
 */
export const updateOrgSettingsMutation = (options?: Partial<Options<UpdateOrgSettingsData>>): MutationOptions<unknown, UpdateOrgSettingsError, Options<UpdateOrgSettingsData>> => {
    const mutationOptions: MutationOptions<unknown, UpdateOrgSettingsError, Options<UpdateOrgSettingsData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const deleteApiKeyMutation = (options?: Partial<Options<DeleteApiKeyData>>): MutationOptions<unknown, DeleteApiKeyError, Options<DeleteApiKeyData>> => {
    const mutationOptions: MutationOptions<unknown, DeleteApiKeyError, Options<DeleteApiKeyData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Revoke an API key (disable it without deleting).
 */
export const revokeApiKeyMutation = (options?: Partial<Options<RevokeApiKeyData>>): MutationOptions<unknown, RevokeApiKeyError, Options<RevokeApiKeyData>> => {
    const mutationOptions: MutationOptions<unknown, RevokeApiKeyError, Options<RevokeApiKeyData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await revokeApiKey({
                ...options,
                ...localOptions,
 ...
 * Generate a signed URL for uploading user avatar image. Only image files are allowed.
 */
export const uploadAvatarMutation = (options?: Partial<Options<UploadAvatarData>>): MutationOptions<UploadAvatarResponse2, UploadAvatarError, Options<UploadAvatarData>> => {
    const mutationOptions: MutationOptions<UploadAvatarResponse2, UploadAvatarError, Options<UploadAvatarData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await uploadAvatar({
                ...options,
                ...localOptions,
 ...
 */
export const changePassword2Mutation = (options?: Partial<Options<ChangePassword2Data>>): MutationOptions<unknown, ChangePassword2Error, Options<ChangePassword2Data>> => {
    const mutationOptions: MutationOptions<unknown, ChangePassword2Error, Options<ChangePassword2Data>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateProfileMutation = (options?: Partial<Options<UpdateProfileData>>): MutationOptions<UpdateProfileResponse, UpdateProfileError, Options<UpdateProfileData>> => {
    const mutationOptions: MutationOptions<UpdateProfileResponse, UpdateProfileError, Options<UpdateProfileData>> = {
        mutationFn: async (localOptions) => {
