 ...
 * Disable TOTP-based 2FA for the authenticated user.
 */
export const disable2FaMutation = (options?: Partial<Options<Disable2FaData>>): MutationOptions<Disable2FaResponse, Disable2FaError, Options<Disable2FaData>> => {
    const mutationOptions: MutationOptions<Disable2FaResponse, Disable2FaError, Options<Disable2FaData>> = {
 ...
 * Enable TOTP-based 2FA for the authenticated user.
 */
export const enable2FaMutation = (options?: Partial<Options<Enable2FaData>>): MutationOptions<Enable2FaResponse, Enable2FaError, Options<Enable2FaData>> => {
    const mutationOptions: MutationOptions<Enable2FaResponse, Enable2FaError, Options<Enable2FaData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await enable2Fa({
                ...options,
                ...localOptions,
 ...
 * Create a user account and start a session. Email verification is required.
 */
export const registerMutation = (options?: Partial<Options<RegisterData>>): MutationOptions<RegisterResponse2, RegisterError, Options<RegisterData>> => {
    const mutationOptions: MutationOptions<RegisterResponse2, RegisterError, Options<RegisterData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await register({
                ...options,
                ...localOptions,
 ...
 * Send a password reset email to the given address if it exists.
 */
export const requestPasswordResetMutation = (options?: Partial<Options<RequestPasswordResetData>>): MutationOptions<RequestPasswordResetResponse, RequestPasswordResetError, Options<RequestPasswordResetData>> => {
    const mutationOptions: MutationOptions<RequestPasswordResetResponse, RequestPasswordResetError, Options<RequestPasswordResetData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await requestPasswordReset({
                ...options,
                ...localOptions,
 ...
 * Resend email verification code, with rate limiting.
 */
export const resendVerificationMutation = (options?: Partial<Options<ResendVerificationData>>): MutationOptions<ResendVerificationResponse, ResendVerificationError, Options<ResendVerificationData>> => {
    const mutationOptions: MutationOptions<ResendVerificationResponse, ResendVerificationError, Options<ResendVerificationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await resendVerification({
                ...options,
                ...localOptions,
 ...
 * Reset the password using a token sent via email.
 */
export const resetPasswordMutation = (options?: Partial<Options<ResetPasswordData>>): MutationOptions<ResetPasswordResponse, ResetPasswordError, Options<ResetPasswordData>> => {
    const mutationOptions: MutationOptions<ResetPasswordResponse, ResetPasswordError, Options<ResetPasswordData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await resetPassword({
                ...options,
                ...localOptions,
 ...
 * Verify the user's email address using a token.
 */
export const verifyEmailMutation = (options?: Partial<Options<VerifyEmailData>>): MutationOptions<VerifyEmailResponse, VerifyEmailError, Options<VerifyEmailData>> => {
    const mutationOptions: MutationOptions<VerifyEmailResponse, VerifyEmailError, Options<VerifyEmailData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await verifyEmail({
                ...options,
                ...localOptions,
 ...
 * Creates a Paddle payment link for the given price. Optionally associates the link to a customer and organization. Use the returned URL to redirect the user to checkout.
 */
export const createCheckoutMutation = (options?: Partial<Options<CreateCheckoutData>>): MutationOptions<CreateCheckoutResponse2, DefaultError, Options<CreateCheckoutData>> => {
    const mutationOptions: MutationOptions<CreateCheckoutResponse2, DefaultError, Options<CreateCheckoutData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createCheckout({
                ...options,
                ...localOptions,
 ...
 * Creates a credit or debit adjustment for the specified invoice.
 */
export const createAdjustmentMutation = (options?: Partial<Options<CreateAdjustmentData>>): MutationOptions<CreateAdjustmentResponse, DefaultError, Options<CreateAdjustmentData>> => {
    const mutationOptions: MutationOptions<CreateAdjustmentResponse, DefaultError, Options<CreateAdjustmentData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createAdjustment({
                ...options,
                ...localOptions,
 ...
 * Requests a refund for a given payment. Amount can be full or partial.
 */
export const refundPaymentMutation = (options?: Partial<Options<RefundPaymentData>>): MutationOptions<RefundPaymentResponse, DefaultError, Options<RefundPaymentData>> => {
    const mutationOptions: MutationOptions<RefundPaymentResponse, DefaultError, Options<RefundPaymentData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await refundPayment({
                ...options,
                ...localOptions,
 ...
 * Creates a subscription for the primary organization. Requires appropriate permissions.
 */
export const createSubscriptionMutation = (options?: Partial<Options<CreateSubscriptionData>>): MutationOptions<unknown, DefaultError, Options<CreateSubscriptionData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<CreateSubscriptionData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createSubscription({
                ...options,
                ...localOptions,
 ...
 * Updates subscription quantity and/or price. Proration behavior can be specified.
 */
export const changeSubscriptionMutation = (options?: Partial<Options<ChangeSubscriptionData>>): MutationOptions<unknown, DefaultError, Options<ChangeSubscriptionData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<ChangeSubscriptionData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await changeSubscription({
                ...options,
                ...localOptions,
 ...
 * Cancels a subscription immediately or schedules cancellation at period end.
 */
export const cancelSubscriptionMutation = (options?: Partial<Options<CancelSubscriptionData>>): MutationOptions<unknown, DefaultError, Options<CancelSubscriptionData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<CancelSubscriptionData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await cancelSubscription({
                ...options,
                ...localOptions,
 ...
 * Resumes a subscription that was scheduled to be canceled at period end.
 */
export const resumeSubscriptionMutation = (options?: Partial<Options<ResumeSubscriptionData>>): MutationOptions<unknown, DefaultError, Options<ResumeSubscriptionData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<ResumeSubscriptionData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await resumeSubscription({
                ...options,
                ...localOptions,
 ...
 * Validates Paddle signature and processes billing events. This endpoint is intended to be called by Paddle.
 */
export const paddleWebhookMutation = (options?: Partial<Options<PaddleWebhookData>>): MutationOptions<unknown, DefaultError, Options<PaddleWebhookData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<PaddleWebhookData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await paddleWebhook({
                ...options,
                ...localOptions,
 ...
 * Identify or create a client-side user by email or anonymous ID in a given org domain.
 */
export const identifyUserMutation = (options?: Partial<Options<IdentifyUserData>>): MutationOptions<IdentifyUserResponse, DefaultError, Options<IdentifyUserData>> => {
    const mutationOptions: MutationOptions<IdentifyUserResponse, DefaultError, Options<IdentifyUserData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await identifyUser({
                ...options,
                ...localOptions,
 ...
 * Submit a message from the client widget; creates a ticket and initial message.
 */
export const sendMessageMutation = (options?: Partial<Options<SendMessageData>>): MutationOptions<SendMessageResponse, DefaultError, Options<SendMessageData>> => {
    const mutationOptions: MutationOptions<SendMessageResponse, DefaultError, Options<SendMessageData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await sendMessage({
                ...options,
                ...localOptions,
 ...
 * Create a new organization and assign the creator as Admin.
 */
export const createOrganizationMutation = (options?: Partial<Options<CreateOrganizationData>>): MutationOptions<CreateOrganizationResponse, DefaultError, Options<CreateOrganizationData>> => {
    const mutationOptions: MutationOptions<CreateOrganizationResponse, DefaultError, Options<CreateOrganizationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createOrganization({
                ...options,
                ...localOptions,
 ...
 * Join an organization if email domain matches and setting allows.
 */
export const joinOrganizationMutation = (options?: Partial<Options<JoinOrganizationData>>): MutationOptions<JoinOrganizationResponse, DefaultError, Options<JoinOrganizationData>> => {
    const mutationOptions: MutationOptions<JoinOrganizationResponse, DefaultError, Options<JoinOrganizationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await joinOrganization({
                ...options,
                ...localOptions,
 ...
 * Accept a pending organization invitation.
 */
export const acceptInvitationMutation = (options?: Partial<Options<AcceptInvitationData>>): MutationOptions<AcceptInvitationResponse, DefaultError, Options<AcceptInvitationData>> => {
    const mutationOptions: MutationOptions<AcceptInvitationResponse, DefaultError, Options<AcceptInvitationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await acceptInvitation({
                ...options,
                ...localOptions,
 ...
 * Suggests priority/assignee/team with confidence and reasons.
 */
export const autoTriageMutation = (options?: Partial<Options<AutoTriageData>>): MutationOptions<AutoTriageResponse, DefaultError, Options<AutoTriageData>> => {
    const mutationOptions: MutationOptions<AutoTriageResponse, DefaultError, Options<AutoTriageData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await autoTriage({
                ...options,
                ...localOptions,
 ...
 * Classifies a ticket into intents, risk, priority, and tags.
 */
export const classifyMutation = (options?: Partial<Options<ClassifyData>>): MutationOptions<ClassifyResponse, ClassifyError, Options<ClassifyData>> => {
    const mutationOptions: MutationOptions<ClassifyResponse, ClassifyError, Options<ClassifyData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await classify({
                ...options,
                ...localOptions,
 ...
 * Aggregates recent conversation, KB snippets, and user profile for prompting.
 */
export const aiContextMutation = (options?: Partial<Options<AiContextData>>): MutationOptions<AiContextResponse2, DefaultError, Options<AiContextData>> => {
    const mutationOptions: MutationOptions<AiContextResponse2, DefaultError, Options<AiContextData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await aiContext({
                ...options,
                ...localOptions,
 ...
 * Suggests relevant knowledge base articles for the ticket context.
 */
export const kbSuggestMutation = (options?: Partial<Options<KbSuggestData>>): MutationOptions<KbSuggestResponse, KbSuggestError, Options<KbSuggestData>> => {
    const mutationOptions: MutationOptions<KbSuggestResponse, KbSuggestError, Options<KbSuggestData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await kbSuggest({
                ...options,
                ...localOptions,
 ...
 * Detects and redacts PII within the provided text.
 */
export const redactMutation = (options?: Partial<Options<RedactData>>): MutationOptions<RedactResponse, RedactError, Options<RedactData>> => {
    const mutationOptions: MutationOptions<RedactResponse, RedactError, Options<RedactData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await redact({
                ...options,
                ...localOptions,
 ...
 * Rewrites text to a specified tone and style.
 */
export const rewriteMutation = (options?: Partial<Options<RewriteData>>): MutationOptions<RewriteResponse, RewriteError, Options<RewriteData>> => {
    const mutationOptions: MutationOptions<RewriteResponse, RewriteError, Options<RewriteData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await rewrite({
                ...options,
                ...localOptions,
 ...
 * Analyzes sentiment and returns label and confidence score.
 */
export const sentimentHandlerMutation = (options?: Partial<Options<SentimentHandlerData>>): MutationOptions<SentimentHandlerResponse, DefaultError, Options<SentimentHandlerData>> => {
    const mutationOptions: MutationOptions<SentimentHandlerResponse, DefaultError, Options<SentimentHandlerData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await sentimentHandler({
                ...options,
                ...localOptions,
 ...
 * Generates a suggested response for a ticket based on recent context.
 */
export const suggestReplyMutation = (options?: Partial<Options<SuggestReplyData>>): MutationOptions<SuggestReplyResponse, SuggestReplyError, Options<SuggestReplyData>> => {
    const mutationOptions: MutationOptions<SuggestReplyResponse, SuggestReplyError, Options<SuggestReplyData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await suggestReply({
                ...options,
                ...localOptions,
 ...
 * Streams a reply suggestion as server-sent events.
 */
export const suggestReplyStreamMutation = (options?: Partial<Options<SuggestReplyStreamData>>): MutationOptions<SuggestReplyStreamResponse, DefaultError, Options<SuggestReplyStreamData>> => {
    const mutationOptions: MutationOptions<SuggestReplyStreamResponse, DefaultError, Options<SuggestReplyStreamData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await suggestReplyStream({
                ...options,
                ...localOptions,
 ...
 * Produces a concise summary, key points, sentiment, and todos for a ticket.
 */
export const summarizeMutation = (options?: Partial<Options<SummarizeData>>): MutationOptions<SummarizeResponse, SummarizeError, Options<SummarizeData>> => {
    const mutationOptions: MutationOptions<SummarizeResponse, SummarizeError, Options<SummarizeData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await summarize({
                ...options,
                ...localOptions,
 ...
 * Streams a ticket summary as server-sent events.
 */
export const summarizeStreamMutation = (options?: Partial<Options<SummarizeStreamData>>): MutationOptions<SummarizeStreamResponse, DefaultError, Options<SummarizeStreamData>> => {
    const mutationOptions: MutationOptions<SummarizeStreamResponse, DefaultError, Options<SummarizeStreamData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await summarizeStream({
                ...options,
                ...localOptions,
 ...
 * Records AI usage events such as acceptance/editing of suggestions.
 */
export const telemetryMutation = (options?: Partial<Options<TelemetryData>>): MutationOptions<TelemetryResponse, TelemetryError, Options<TelemetryData>> => {
    const mutationOptions: MutationOptions<TelemetryResponse, TelemetryError, Options<TelemetryData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await telemetry({
                ...options,
                ...localOptions,
 ...
 * Translates provided text to a target locale.
 */
export const translateMutation = (options?: Partial<Options<TranslateData>>): MutationOptions<TranslateResponse, TranslateError, Options<TranslateData>> => {
    const mutationOptions: MutationOptions<TranslateResponse, TranslateError, Options<TranslateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await translate({
                ...options,
                ...localOptions,
 ...
 * Translates all messages in the ticket to the target locale.
 */
export const translateConversationMutation = (options?: Partial<Options<TranslateConversationData>>): MutationOptions<TranslateConversationResponse, DefaultError, Options<TranslateConversationData>> => {
    const mutationOptions: MutationOptions<TranslateConversationResponse, DefaultError, Options<TranslateConversationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await translateConversation({
                ...options,
                ...localOptions,
 ...
 * Streams a translation as server-sent events.
 */
export const translateStreamMutation = (options?: Partial<Options<TranslateStreamData>>): MutationOptions<TranslateStreamResponse, DefaultError, Options<TranslateStreamData>> => {
    const mutationOptions: MutationOptions<TranslateStreamResponse, DefaultError, Options<TranslateStreamData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await translateStream({
                ...options,
                ...localOptions,
 ...
 * Manually trigger execution of automation rules with optional context.
 */
export const executeAutomationRulesMutation = (options?: Partial<Options<ExecuteAutomationRulesData>>): MutationOptions<ExecuteAutomationRulesResponse, DefaultError, Options<ExecuteAutomationRulesData>> => {
    const mutationOptions: MutationOptions<ExecuteAutomationRulesResponse, DefaultError, Options<ExecuteAutomationRulesData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await executeAutomationRules({
                ...options,
                ...localOptions,
 ...
 * Create a new automation rule with trigger, conditions, and actions.
 */
export const createAutomationRuleMutation = (options?: Partial<Options<CreateAutomationRuleData>>): MutationOptions<CreateAutomationRuleResponse, DefaultError, Options<CreateAutomationRuleData>> => {
    const mutationOptions: MutationOptions<CreateAutomationRuleResponse, DefaultError, Options<CreateAutomationRuleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createAutomationRule({
                ...options,
                ...localOptions,
 ...
 */
export const deleteAutomationRuleMutation = (options?: Partial<Options<DeleteAutomationRuleData>>): MutationOptions<unknown, DefaultError, Options<DeleteAutomationRuleData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<DeleteAutomationRuleData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateAutomationRuleMutation = (options?: Partial<Options<UpdateAutomationRuleData>>): MutationOptions<UpdateAutomationRuleResponse, DefaultError, Options<UpdateAutomationRuleData>> => {
    const mutationOptions: MutationOptions<UpdateAutomationRuleResponse, DefaultError, Options<UpdateAutomationRuleData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Creates a custom event in the audit trail.
 */
export const createEventMutation = (options?: Partial<Options<CreateEventData>>): MutationOptions<CreateEventResponse, CreateEventError, Options<CreateEventData>> => {
    const mutationOptions: MutationOptions<CreateEventResponse, CreateEventError, Options<CreateEventData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createEvent({
                ...options,
                ...localOptions,
 ...
 * Invite a user to join the organization.
 */
export const inviteUserMutation = (options?: Partial<Options<InviteUserData>>): MutationOptions<InviteUserResponse, DefaultError, Options<InviteUserData>> => {
    const mutationOptions: MutationOptions<InviteUserResponse, DefaultError, Options<InviteUserData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await inviteUser({
                ...options,
                ...localOptions,
...
export const createArticleMutation = (options?: Partial<Options<CreateArticleData>>): MutationOptions<CreateArticleResponse, CreateArticleError, Options<CreateArticleData>> => {
    const mutationOptions: MutationOptions<CreateArticleResponse, CreateArticleError, Options<CreateArticleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createArticle({
                ...options,
                ...localOptions,
...
export const deleteArticleMutation = (options?: Partial<Options<DeleteArticleData>>): MutationOptions<DeleteArticleResponse, DeleteArticleError, Options<DeleteArticleData>> => {
    const mutationOptions: MutationOptions<DeleteArticleResponse, DeleteArticleError, Options<DeleteArticleData>> = {
        mutationFn: async (localOptions) => {
...
export const updateArticleMutation = (options?: Partial<Options<UpdateArticleData>>): MutationOptions<UpdateArticleResponse, UpdateArticleError, Options<UpdateArticleData>> => {
    const mutationOptions: MutationOptions<UpdateArticleResponse, UpdateArticleError, Options<UpdateArticleData>> = {
        mutationFn: async (localOptions) => {
...
export const recordArticleAcceptMutation = (options?: Partial<Options<RecordArticleAcceptData>>): MutationOptions<RecordArticleAcceptResponse, DefaultError, Options<RecordArticleAcceptData>> => {
    const mutationOptions: MutationOptions<RecordArticleAcceptResponse, DefaultError, Options<RecordArticleAcceptData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await recordArticleAccept({
                ...options,
                ...localOptions,
...
export const publishArticleMutation = (options?: Partial<Options<PublishArticleData>>): MutationOptions<PublishArticleResponse, DefaultError, Options<PublishArticleData>> => {
    const mutationOptions: MutationOptions<PublishArticleResponse, DefaultError, Options<PublishArticleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await publishArticle({
                ...options,
                ...localOptions,
...
export const reindexArticleEmbeddingMutation = (options?: Partial<Options<ReindexArticleEmbeddingData>>): MutationOptions<unknown, DefaultError, Options<ReindexArticleEmbeddingData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<ReindexArticleEmbeddingData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await reindexArticleEmbedding({
                ...options,
                ...localOptions,
...
export const unpublishArticleMutation = (options?: Partial<Options<UnpublishArticleData>>): MutationOptions<UnpublishArticleResponse, DefaultError, Options<UnpublishArticleData>> => {
    const mutationOptions: MutationOptions<UnpublishArticleResponse, DefaultError, Options<UnpublishArticleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await unpublishArticle({
                ...options,
                ...localOptions,
...
export const voteArticleMutation = (options?: Partial<Options<VoteArticleData>>): MutationOptions<VoteArticleResponse, DefaultError, Options<VoteArticleData>> => {
    const mutationOptions: MutationOptions<VoteArticleResponse, DefaultError, Options<VoteArticleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await voteArticle({
                ...options,
                ...localOptions,
...
export const createCategoryMutation = (options?: Partial<Options<CreateCategoryData>>): MutationOptions<CreateCategoryResponse, DefaultError, Options<CreateCategoryData>> => {
    const mutationOptions: MutationOptions<CreateCategoryResponse, DefaultError, Options<CreateCategoryData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createCategory({
                ...options,
                ...localOptions,
...
export const deleteCategoryMutation = (options?: Partial<Options<DeleteCategoryData>>): MutationOptions<DeleteCategoryResponse, DefaultError, Options<DeleteCategoryData>> => {
    const mutationOptions: MutationOptions<DeleteCategoryResponse, DefaultError, Options<DeleteCategoryData>> = {
        mutationFn: async (localOptions) => {
...
export const updateCategoryMutation = (options?: Partial<Options<UpdateCategoryData>>): MutationOptions<UpdateCategoryResponse, DefaultError, Options<UpdateCategoryData>> => {
    const mutationOptions: MutationOptions<UpdateCategoryResponse, DefaultError, Options<UpdateCategoryData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Create a reusable response template. Requires MANAGE_MACROS.
 */
export const createMacroMutation = (options?: Partial<Options<CreateMacroData>>): MutationOptions<CreateMacroResponse, CreateMacroError, Options<CreateMacroData>> => {
    const mutationOptions: MutationOptions<CreateMacroResponse, CreateMacroError, Options<CreateMacroData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createMacro({
                ...options,
                ...localOptions,
 ...
 */
export const deleteMacroExperimentMutation = (options?: Partial<Options<DeleteMacroExperimentData>>): MutationOptions<DeleteMacroExperimentResponse, DefaultError, Options<DeleteMacroExperimentData>> => {
    const mutationOptions: MutationOptions<DeleteMacroExperimentResponse, DefaultError, Options<DeleteMacroExperimentData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateMacroExperimentMutation = (options?: Partial<Options<UpdateMacroExperimentData>>): MutationOptions<UpdateMacroExperimentResponse, DefaultError, Options<UpdateMacroExperimentData>> => {
    const mutationOptions: MutationOptions<UpdateMacroExperimentResponse, DefaultError, Options<UpdateMacroExperimentData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Render a macro template with variables and optional channel/locale.
 */
export const renderMacroTemplateMutation = (options?: Partial<Options<RenderMacroTemplateData>>): MutationOptions<RenderMacroTemplateResponse, RenderMacroTemplateError, Options<RenderMacroTemplateData>> => {
    const mutationOptions: MutationOptions<RenderMacroTemplateResponse, RenderMacroTemplateError, Options<RenderMacroTemplateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await renderMacroTemplate({
                ...options,
                ...localOptions,
 ...
 */
export const deleteMacroMutation = (options?: Partial<Options<DeleteMacroData>>): MutationOptions<DeleteMacroResponse, DeleteMacroError, Options<DeleteMacroData>> => {
    const mutationOptions: MutationOptions<DeleteMacroResponse, DeleteMacroError, Options<DeleteMacroData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateMacroMutation = (options?: Partial<Options<UpdateMacroData>>): MutationOptions<UpdateMacroResponse, UpdateMacroError, Options<UpdateMacroData>> => {
    const mutationOptions: MutationOptions<UpdateMacroResponse, UpdateMacroError, Options<UpdateMacroData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Create an experiment to A/B test macro variants.
 */
export const createMacroExperimentMutation = (options?: Partial<Options<CreateMacroExperimentData>>): MutationOptions<CreateMacroExperimentResponse, DefaultError, Options<CreateMacroExperimentData>> => {
    const mutationOptions: MutationOptions<CreateMacroExperimentResponse, DefaultError, Options<CreateMacroExperimentData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createMacroExperiment({
                ...options,
                ...localOptions,
 ...
 * Create a channel/locale variant for a macro.
 */
export const createMacroVariantMutation = (options?: Partial<Options<CreateMacroVariantData>>): MutationOptions<CreateMacroVariantResponse, DefaultError, Options<CreateMacroVariantData>> => {
    const mutationOptions: MutationOptions<CreateMacroVariantResponse, DefaultError, Options<CreateMacroVariantData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createMacroVariant({
                ...options,
                ...localOptions,
 ...
 */
export const deleteMacroVariantMutation = (options?: Partial<Options<DeleteMacroVariantData>>): MutationOptions<DeleteMacroVariantResponse, DefaultError, Options<DeleteMacroVariantData>> => {
    const mutationOptions: MutationOptions<DeleteMacroVariantResponse, DefaultError, Options<DeleteMacroVariantData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateMacroVariantMutation = (options?: Partial<Options<UpdateMacroVariantData>>): MutationOptions<UpdateMacroVariantResponse, DefaultError, Options<UpdateMacroVariantData>> => {
    const mutationOptions: MutationOptions<UpdateMacroVariantResponse, DefaultError, Options<UpdateMacroVariantData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const removeMemberMutation = (options?: Partial<Options<RemoveMemberData>>): MutationOptions<RemoveMemberResponse, DefaultError, Options<RemoveMemberData>> => {
    const mutationOptions: MutationOptions<RemoveMemberResponse, DefaultError, Options<RemoveMemberData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateMembershipMutation = (options?: Partial<Options<UpdateMembershipData>>): MutationOptions<UpdateMembershipResponse, DefaultError, Options<UpdateMembershipData>> => {
    const mutationOptions: MutationOptions<UpdateMembershipResponse, DefaultError, Options<UpdateMembershipData>> = {
        mutationFn: async (localOptions) => {
...
export const deleteMessageMutation = (options?: Partial<Options<DeleteMessageData>>): MutationOptions<DeleteMessageResponse, DeleteMessageError, Options<DeleteMessageData>> => {
    const mutationOptions: MutationOptions<DeleteMessageResponse, DeleteMessageError, Options<DeleteMessageData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Send a presence heartbeat to update agent status and current/editing ticket context.
 */
export const heartbeatMutation = (options?: Partial<Options<HeartbeatData>>): MutationOptions<HeartbeatResponse, DefaultError, Options<HeartbeatData>> => {
    const mutationOptions: MutationOptions<HeartbeatResponse, DefaultError, Options<HeartbeatData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await heartbeat({
                ...options,
                ...localOptions,
 ...
 * Create a new role with a permission bitmask and display settings.
 */
export const createRoleMutation = (options?: Partial<Options<CreateRoleData>>): MutationOptions<CreateRoleResponse, DefaultError, Options<CreateRoleData>> => {
    const mutationOptions: MutationOptions<CreateRoleResponse, DefaultError, Options<CreateRoleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createRole({
                ...options,
                ...localOptions,
 ...
 * Delete a role by ID.
 */
export const deleteRoleMutation = (options?: Partial<Options<DeleteRoleData>>): MutationOptions<DeleteRoleResponse, DefaultError, Options<DeleteRoleData>> => {
    const mutationOptions: MutationOptions<DeleteRoleResponse, DefaultError, Options<DeleteRoleData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Assign a role to a user.
 */
export const assignRoleMutation = (options?: Partial<Options<AssignRoleData>>): MutationOptions<AssignRoleResponse, DefaultError, Options<AssignRoleData>> => {
    const mutationOptions: MutationOptions<AssignRoleResponse, DefaultError, Options<AssignRoleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await assignRole({
                ...options,
                ...localOptions,
 ...
 * Revoke a role from a user.
 */
export const revokeRoleMutation = (options?: Partial<Options<RevokeRoleData>>): MutationOptions<RevokeRoleResponse, DefaultError, Options<RevokeRoleData>> => {
    const mutationOptions: MutationOptions<RevokeRoleResponse, DefaultError, Options<RevokeRoleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await revokeRole({
                ...options,
                ...localOptions,
 ...
 * Create a ticket routing rule with strategy, conditions, and actions.
 */
export const createRuleMutation = (options?: Partial<Options<CreateRuleData>>): MutationOptions<CreateRuleResponse, DefaultError, Options<CreateRuleData>> => {
    const mutationOptions: MutationOptions<CreateRuleResponse, DefaultError, Options<CreateRuleData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createRule({
                ...options,
                ...localOptions,
 ...
 */
export const deleteRuleMutation = (options?: Partial<Options<DeleteRuleData>>): MutationOptions<DeleteRuleResponse, DefaultError, Options<DeleteRuleData>> => {
    const mutationOptions: MutationOptions<DeleteRuleResponse, DefaultError, Options<DeleteRuleData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateRuleMutation = (options?: Partial<Options<UpdateRuleData>>): MutationOptions<UpdateRuleResponse, DefaultError, Options<UpdateRuleData>> => {
    const mutationOptions: MutationOptions<UpdateRuleResponse, DefaultError, Options<UpdateRuleData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Create or update an organization setting.
 */
export const setOrganizationSettingMutation = (options?: Partial<Options<SetOrganizationSettingData>>): MutationOptions<SetOrganizationSettingResponse, DefaultError, Options<SetOrganizationSettingData>> => {
    const mutationOptions: MutationOptions<SetOrganizationSettingResponse, DefaultError, Options<SetOrganizationSettingData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await setOrganizationSetting({
                ...options,
                ...localOptions,
 ...
 * Run data retention worker once for the organization.
 */
export const applyDataRetentionMutation = (options?: Partial<Options<ApplyDataRetentionData>>): MutationOptions<ApplyDataRetentionResponse, DefaultError, Options<ApplyDataRetentionData>> => {
    const mutationOptions: MutationOptions<ApplyDataRetentionResponse, DefaultError, Options<ApplyDataRetentionData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await applyDataRetention({
                ...options,
                ...localOptions,
 ...
 */
export const deleteOrganizationSettingMutation = (options?: Partial<Options<DeleteOrganizationSettingData>>): MutationOptions<DeleteOrganizationSettingResponse, DefaultError, Options<DeleteOrganizationSettingData>> => {
    const mutationOptions: MutationOptions<DeleteOrganizationSettingResponse, DefaultError, Options<DeleteOrganizationSettingData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Evaluate tickets against SLA policies and mark breaches.
 */
export const checkBreachesMutation = (options?: Partial<Options<CheckBreachesData>>): MutationOptions<CheckBreachesResponse, DefaultError, Options<CheckBreachesData>> => {
    const mutationOptions: MutationOptions<CheckBreachesResponse, DefaultError, Options<CheckBreachesData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await checkBreaches({
                ...options,
                ...localOptions,
 ...
 * Create an SLA policy with conditions and targets.
 */
export const createPolicyMutation = (options?: Partial<Options<CreatePolicyData>>): MutationOptions<CreatePolicyResponse, DefaultError, Options<CreatePolicyData>> => {
    const mutationOptions: MutationOptions<CreatePolicyResponse, DefaultError, Options<CreatePolicyData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createPolicy({
                ...options,
                ...localOptions,
 ...
 */
export const updatePolicyMutation = (options?: Partial<Options<UpdatePolicyData>>): MutationOptions<UpdatePolicyResponse, DefaultError, Options<UpdatePolicyData>> => {
    const mutationOptions: MutationOptions<UpdatePolicyResponse, DefaultError, Options<UpdatePolicyData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Submit a customer satisfaction survey for a ticket.
 */
export const submitSurveyMutation = (options?: Partial<Options<SubmitSurveyData>>): MutationOptions<SubmitSurveyResponse, DefaultError, Options<SubmitSurveyData>> => {
    const mutationOptions: MutationOptions<SubmitSurveyResponse, DefaultError, Options<SubmitSurveyData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await submitSurvey({
                ...options,
                ...localOptions,
 ...
 */
export const deleteSurveyMutation = (options?: Partial<Options<DeleteSurveyData>>): MutationOptions<unknown, DefaultError, Options<DeleteSurveyData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<DeleteSurveyData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateSurveyMutation = (options?: Partial<Options<UpdateSurveyData>>): MutationOptions<UpdateSurveyResponse, DefaultError, Options<UpdateSurveyData>> => {
    const mutationOptions: MutationOptions<UpdateSurveyResponse, DefaultError, Options<UpdateSurveyData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Batch apply sync operations with optimistic concurrency. Currently supports entity=ticket with upsert of core fields.
 */
export const syncOpsMutation = (options?: Partial<Options<SyncOpsData>>): MutationOptions<SyncOpsResponse2, DefaultError, Options<SyncOpsData>> => {
    const mutationOptions: MutationOptions<SyncOpsResponse2, DefaultError, Options<SyncOpsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await syncOps({
                ...options,
                ...localOptions,
 ...
 * Create a new tag within the organization. Requires MANAGE_TAGS.
 */
export const createTagMutation = (options?: Partial<Options<CreateTagData>>): MutationOptions<CreateTagResponse, DefaultError, Options<CreateTagData>> => {
 ...
 */
export const deleteTagMutation = (options?: Partial<Options<DeleteTagData>>): MutationOptions<DeleteTagResponse, DefaultError, Options<DeleteTagData>> => {
    const mutationOptions: MutationOptions<DeleteTagResponse, DefaultError, Options<DeleteTagData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateTagMutation = (options?: Partial<Options<UpdateTagData>>): MutationOptions<UpdateTagResponse, DefaultError, Options<UpdateTagData>> => {
    const mutationOptions: MutationOptions<UpdateTagResponse, DefaultError, Options<UpdateTagData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Create a team within the organization.
 */
export const createTeamMutation = (options?: Partial<Options<CreateTeamData>>): MutationOptions<CreateTeamResponse, DefaultError, Options<CreateTeamData>> => {
    const mutationOptions: MutationOptions<CreateTeamResponse, DefaultError, Options<CreateTeamData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createTeam({
                ...options,
                ...localOptions,
 ...
 */
export const updateTeamMutation = (options?: Partial<Options<UpdateTeamData>>): MutationOptions<UpdateTeamResponse, DefaultError, Options<UpdateTeamData>> => {
    const mutationOptions: MutationOptions<UpdateTeamResponse, DefaultError, Options<UpdateTeamData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Add a user to a team with a role.
 */
export const addMemberMutation = (options?: Partial<Options<AddMemberData>>): MutationOptions<AddMemberResponse, DefaultError, Options<AddMemberData>> => {
    const mutationOptions: MutationOptions<AddMemberResponse, DefaultError, Options<AddMemberData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await addMember({
                ...options,
                ...localOptions,
 ...
 */
export const removeMember2Mutation = (options?: Partial<Options<RemoveMember2Data>>): MutationOptions<RemoveMember2Response, DefaultError, Options<RemoveMember2Data>> => {
    const mutationOptions: MutationOptions<RemoveMember2Response, DefaultError, Options<RemoveMember2Data>> = {
        mutationFn: async (localOptions) => {
 ...
 * Bulk update tickets
 */
export const bulkUpdateTicketsMutation = (options?: Partial<Options<BulkUpdateTicketsData>>): MutationOptions<unknown, DefaultError, Options<BulkUpdateTicketsData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<BulkUpdateTicketsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await bulkUpdateTickets({
                ...options,
                ...localOptions,
 ...
 * Merge two tickets
 */
export const mergeTicketsMutation = (options?: Partial<Options<MergeTicketsData>>): MutationOptions<unknown, DefaultError, Options<MergeTicketsData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<MergeTicketsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await mergeTickets({
                ...options,
                ...localOptions,
 ...
 * Split a ticket's selected messages into a new ticket
 */
export const splitTicketMutation = (options?: Partial<Options<SplitTicketData>>): MutationOptions<SplitTicketResponse, DefaultError, Options<SplitTicketData>> => {
    const mutationOptions: MutationOptions<SplitTicketResponse, DefaultError, Options<SplitTicketData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await splitTicket({
                ...options,
                ...localOptions,
 ...
 * Create a saved view
 */
export const createSavedViewMutation = (options?: Partial<Options<CreateSavedViewData>>): MutationOptions<CreateSavedViewResponse, DefaultError, Options<CreateSavedViewData>> => {
    const mutationOptions: MutationOptions<CreateSavedViewResponse, DefaultError, Options<CreateSavedViewData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createSavedView({
                ...options,
                ...localOptions,
...
export const deleteTicketMutation = (options?: Partial<Options<DeleteTicketData>>): MutationOptions<DeleteTicketResponse, DeleteTicketError, Options<DeleteTicketData>> => {
    const mutationOptions: MutationOptions<DeleteTicketResponse, DeleteTicketError, Options<DeleteTicketData>> = {
        mutationFn: async (localOptions) => {
...
export const assignTicketTeamMutation = (options?: Partial<Options<AssignTicketTeamData>>): MutationOptions<AssignTicketTeamResponse, AssignTicketTeamError, Options<AssignTicketTeamData>> => {
    const mutationOptions: MutationOptions<AssignTicketTeamResponse, AssignTicketTeamError, Options<AssignTicketTeamData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await assignTicketTeam({
                ...options,
                ...localOptions,
...
export const clearTicketTeamAssignmentMutation = (options?: Partial<Options<ClearTicketTeamAssignmentData>>): MutationOptions<ClearTicketTeamAssignmentResponse, DefaultError, Options<ClearTicketTeamAssignmentData>> => {
    const mutationOptions: MutationOptions<ClearTicketTeamAssignmentResponse, DefaultError, Options<ClearTicketTeamAssignmentData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const deleteDraftMutation = (options?: Partial<Options<DeleteDraftData>>): MutationOptions<DeleteDraftResponse, DefaultError, Options<DeleteDraftData>> => {
    const mutationOptions: MutationOptions<DeleteDraftResponse, DefaultError, Options<DeleteDraftData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Create or update a draft for a ticket
 */
export const upsertDraftMutation = (options?: Partial<Options<UpsertDraftData>>): MutationOptions<UpsertDraftResponse, DefaultError, Options<UpsertDraftData>> => {
    const mutationOptions: MutationOptions<UpsertDraftResponse, DefaultError, Options<UpsertDraftData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await upsertDraft({
                ...options,
                ...localOptions,
 ...
 * Generate AI draft reply for a ticket
 */
export const aiGenerateDraftMutation = (options?: Partial<Options<AiGenerateDraftData>>): MutationOptions<AiGenerateDraftResponse, DefaultError, Options<AiGenerateDraftData>> => {
    const mutationOptions: MutationOptions<AiGenerateDraftResponse, DefaultError, Options<AiGenerateDraftData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await aiGenerateDraft({
                ...options,
                ...localOptions,
...
export const releaseTicketLockMutation = (options?: Partial<Options<ReleaseTicketLockData>>): MutationOptions<ReleaseTicketLockResponse, DefaultError, Options<ReleaseTicketLockData>> => {
    const mutationOptions: MutationOptions<ReleaseTicketLockResponse, DefaultError, Options<ReleaseTicketLockData>> = {
        mutationFn: async (localOptions) => {
...
export const lockTicketMutation = (options?: Partial<Options<LockTicketData>>): MutationOptions<unknown, DefaultError, Options<LockTicketData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<LockTicketData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await lockTicket({
                ...options,
                ...localOptions,
...
export const takeoverTicketLockMutation = (options?: Partial<Options<TakeoverTicketLockData>>): MutationOptions<unknown, DefaultError, Options<TakeoverTicketLockData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<TakeoverTicketLockData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await takeoverTicketLock({
                ...options,
                ...localOptions,
...
export const createMessageMutation = (options?: Partial<Options<CreateMessageData>>): MutationOptions<CreateMessageResponse, CreateMessageError, Options<CreateMessageData>> => {
    const mutationOptions: MutationOptions<CreateMessageResponse, CreateMessageError, Options<CreateMessageData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createMessage({
                ...options,
                ...localOptions,
...
export const createInternalNoteMutation = (options?: Partial<Options<CreateInternalNoteData>>): MutationOptions<CreateInternalNoteResponse, DefaultError, Options<CreateInternalNoteData>> => {
    const mutationOptions: MutationOptions<CreateInternalNoteResponse, DefaultError, Options<CreateInternalNoteData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createInternalNote({
                ...options,
                ...localOptions,
...
export const uploadAttachmentsMutation = (options?: Partial<Options<UploadAttachmentsData>>): MutationOptions<UploadAttachmentsResponse, UploadAttachmentsError, Options<UploadAttachmentsData>> => {
    const mutationOptions: MutationOptions<UploadAttachmentsResponse, UploadAttachmentsError, Options<UploadAttachmentsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await uploadAttachments({
                ...options,
                ...localOptions,
...
export const deleteAttachmentMutation = (options?: Partial<Options<DeleteAttachmentData>>): MutationOptions<DeleteAttachmentResponse, DeleteAttachmentError, Options<DeleteAttachmentData>> => {
    const mutationOptions: MutationOptions<DeleteAttachmentResponse, DeleteAttachmentError, Options<DeleteAttachmentData>> = {
        mutationFn: async (localOptions) => {
...
export const removeTagsFromTicketMutation = (options?: Partial<Options<RemoveTagsFromTicketData>>): MutationOptions<RemoveTagsFromTicketResponse, RemoveTagsFromTicketError, Options<RemoveTagsFromTicketData>> => {
    const mutationOptions: MutationOptions<RemoveTagsFromTicketResponse, RemoveTagsFromTicketError, Options<RemoveTagsFromTicketData>> = {
        mutationFn: async (localOptions) => {
...
export const addTagsToTicketMutation = (options?: Partial<Options<AddTagsToTicketData>>): MutationOptions<unknown, AddTagsToTicketError, Options<AddTagsToTicketData>> => {
    const mutationOptions: MutationOptions<unknown, AddTagsToTicketError, Options<AddTagsToTicketData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await addTagsToTicket({
                ...options,
                ...localOptions,
 ...
 * Set or clear the caller's typing state for a specific ticket.
 */
export const typingUpdateMutation = (options?: Partial<Options<TypingUpdateData>>): MutationOptions<TypingUpdateResponse, DefaultError, Options<TypingUpdateData>> => {
    const mutationOptions: MutationOptions<TypingUpdateResponse, DefaultError, Options<TypingUpdateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await typingUpdate({
                ...options,
                ...localOptions,
...
export const addTicketWatcherMutation = (options?: Partial<Options<AddTicketWatcherData>>): MutationOptions<AddTicketWatcherResponse, DefaultError, Options<AddTicketWatcherData>> => {
    const mutationOptions: MutationOptions<AddTicketWatcherResponse, DefaultError, Options<AddTicketWatcherData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await addTicketWatcher({
                ...options,
                ...localOptions,
...
export const removeTicketWatcherMutation = (options?: Partial<Options<RemoveTicketWatcherData>>): MutationOptions<RemoveTicketWatcherResponse, DefaultError, Options<RemoveTicketWatcherData>> => {
    const mutationOptions: MutationOptions<RemoveTicketWatcherResponse, DefaultError, Options<RemoveTicketWatcherData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Define a per-organization custom field for users (e.g., plan, region).
 */
export const createCustomFieldMutation = (options?: Partial<Options<CreateCustomFieldData>>): MutationOptions<CreateCustomFieldResponse, DefaultError, Options<CreateCustomFieldData>> => {
    const mutationOptions: MutationOptions<CreateCustomFieldResponse, DefaultError, Options<CreateCustomFieldData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createCustomField({
                ...options,
                ...localOptions,
 ...
 */
export const deleteCustomFieldMutation = (options?: Partial<Options<DeleteCustomFieldData>>): MutationOptions<DeleteCustomFieldResponse, DefaultError, Options<DeleteCustomFieldData>> => {
    const mutationOptions: MutationOptions<DeleteCustomFieldResponse, DefaultError, Options<DeleteCustomFieldData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Create a segment of users based on custom field rules.
 */
export const createSegmentMutation = (options?: Partial<Options<CreateSegmentData>>): MutationOptions<CreateSegmentResponse, DefaultError, Options<CreateSegmentData>> => {
    const mutationOptions: MutationOptions<CreateSegmentResponse, DefaultError, Options<CreateSegmentData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createSegment({
                ...options,
                ...localOptions,
 ...
 */
export const deleteSegmentMutation = (options?: Partial<Options<DeleteSegmentData>>): MutationOptions<DeleteSegmentResponse, DefaultError, Options<DeleteSegmentData>> => {
    const mutationOptions: MutationOptions<DeleteSegmentResponse, DefaultError, Options<DeleteSegmentData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateSegmentMutation = (options?: Partial<Options<UpdateSegmentData>>): MutationOptions<UpdateSegmentResponse, DefaultError, Options<UpdateSegmentData>> => {
    const mutationOptions: MutationOptions<UpdateSegmentResponse, DefaultError, Options<UpdateSegmentData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Evaluate and return the list of user IDs matching the segment rules.
 */
export const evaluateSegmentMutation = (options?: Partial<Options<EvaluateSegmentData>>): MutationOptions<EvaluateSegmentResponse2, DefaultError, Options<EvaluateSegmentData>> => {
    const mutationOptions: MutationOptions<EvaluateSegmentResponse2, DefaultError, Options<EvaluateSegmentData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await evaluateSegment({
                ...options,
                ...localOptions,
 ...
 */
export const setUserCustomFieldsMutation = (options?: Partial<Options<SetUserCustomFieldsData>>): MutationOptions<SetUserCustomFieldsResponse, DefaultError, Options<SetUserCustomFieldsData>> => {
    const mutationOptions: MutationOptions<SetUserCustomFieldsResponse, DefaultError, Options<SetUserCustomFieldsData>> = {
        mutationFn: async (localOptions) => {
 ...
 * Create a webhook endpoint subscribed to specific events.
 */
export const createWebhookMutation = (options?: Partial<Options<CreateWebhookData>>): MutationOptions<CreateWebhookResponse, CreateWebhookError, Options<CreateWebhookData>> => {
    const mutationOptions: MutationOptions<CreateWebhookResponse, CreateWebhookError, Options<CreateWebhookData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createWebhook({
                ...options,
                ...localOptions,
 ...
 * Trigger subscribed webhooks for the specified event with optional context.
 */
export const sendWebhooksMutation = (options?: Partial<Options<SendWebhooksData>>): MutationOptions<SendWebhooksResponse, DefaultError, Options<SendWebhooksData>> => {
    const mutationOptions: MutationOptions<SendWebhooksResponse, DefaultError, Options<SendWebhooksData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await sendWebhooks({
                ...options,
                ...localOptions,
 ...
 * Send a test event to the webhook and return the delivery result.
 */
export const testWebhookMutation = (options?: Partial<Options<TestWebhookData>>): MutationOptions<TestWebhookResponse, DefaultError, Options<TestWebhookData>> => {
    const mutationOptions: MutationOptions<TestWebhookResponse, DefaultError, Options<TestWebhookData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await testWebhook({
                ...options,
                ...localOptions,
 ...
 * Delete expired sessions for all users.
 */
export const cleanupExpiredSessionsMutation = (options?: Partial<Options<CleanupExpiredSessionsData>>): MutationOptions<unknown, DefaultError, Options<CleanupExpiredSessionsData>> => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<CleanupExpiredSessionsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await cleanupExpiredSessions({
                ...options,
                ...localOptions,
 ...
 * Extend the expiration of a specific session.
 */
export const extendSessionMutation = (options?: Partial<Options<ExtendSessionData>>): MutationOptions<ExtendSessionResponse, DefaultError, Options<ExtendSessionData>> => {
    const mutationOptions: MutationOptions<ExtendSessionResponse, DefaultError, Options<ExtendSessionData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await extendSession({
                ...options,
                ...localOptions,
 ...
 */
export const deleteAccountMutation = (options?: Partial<Options<DeleteAccountData>>): MutationOptions<DeleteAccountResponse, DefaultError, Options<DeleteAccountData>> => {
    const mutationOptions: MutationOptions<DeleteAccountResponse, DefaultError, Options<DeleteAccountData>> = {
        mutationFn: async (localOptions) => {
...
export const createApiKeyMutation = (options?: Partial<Options<CreateApiKeyData>>): MutationOptions<CreateApiKeyResponse2, CreateApiKeyError, Options<CreateApiKeyData>> => {
    const mutationOptions: MutationOptions<CreateApiKeyResponse2, CreateApiKeyError, Options<CreateApiKeyData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createApiKey({
                ...options,
                ...localOptions,
...
export const deleteApiKeyMutation = (options?: Partial<Options<DeleteApiKeyData>>): MutationOptions<DeleteApiKeyResponse, DefaultError, Options<DeleteApiKeyData>> => {
    const mutationOptions: MutationOptions<DeleteApiKeyResponse, DefaultError, Options<DeleteApiKeyData>> = {
        mutationFn: async (localOptions) => {
...
export const revokeApiKeyMutation = (options?: Partial<Options<RevokeApiKeyData>>): MutationOptions<RevokeApiKeyResponse, DefaultError, Options<RevokeApiKeyData>> => {
    const mutationOptions: MutationOptions<RevokeApiKeyResponse, DefaultError, Options<RevokeApiKeyData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await revokeApiKey({
                ...options,
                ...localOptions,
 ...
 */
export const changePasswordMutation = (options?: Partial<Options<ChangePasswordData>>): MutationOptions<ChangePasswordResponse, ChangePasswordError, Options<ChangePasswordData>> => {
    const mutationOptions: MutationOptions<ChangePasswordResponse, ChangePasswordError, Options<ChangePasswordData>> = {
        mutationFn: async (localOptions) => {
 ...
 */
export const updateProfileMutation = (options?: Partial<Options<UpdateProfileData>>): MutationOptions<UpdateProfileResponse, DefaultError, Options<UpdateProfileData>> => {
    const mutationOptions: MutationOptions<UpdateProfileResponse, DefaultError, Options<UpdateProfileData>> = {
        mutationFn: async (localOptions) => {
