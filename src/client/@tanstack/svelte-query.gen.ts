...
export const getActionsCatalogQueryKey = (options: Options<GetActionsCatalogData>) => createQueryKey('getActionsCatalog', options);

/**
 * Get allowed actions for the current context
 */
export const getActionsCatalogOptions = (options: Options<GetActionsCatalogData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getActionsCatalog({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getActionsCatalogQueryKey(options)
    });
};

export const executeActionQueryKey = (options: Options<ExecuteActionData>) => createQueryKey('executeAction', options);

/**
 * Execute a self-serve action
 */
export const executeActionOptions = (options: Options<ExecuteActionData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: executeActionQueryKey(options)
    });
};
 ...
 * Execute a self-serve action
 */
export const executeActionMutation = (options?: Partial<Options<ExecuteActionData>>): MutationOptions<ExecuteActionResponse, DefaultError, Options<ExecuteActionData>> => {
    const mutationOptions: MutationOptions<ExecuteActionResponse, DefaultError, Options<ExecuteActionData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await executeAction({
                ...options,
                ...localOptions,
...
export const linkResourcesQueryKey = (options: Options<LinkResourcesData>) => createQueryKey('linkResources', options);

/**
 * Link typed resources to a user or ticket
 */
export const linkResourcesOptions = (options: Options<LinkResourcesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await linkResources({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: linkResourcesQueryKey(options)
    });
};
 ...
 * Link typed resources to a user or ticket
 */
export const linkResourcesMutation = (options?: Partial<Options<LinkResourcesData>>): MutationOptions<LinkResourcesResponse2, DefaultError, Options<LinkResourcesData>> => {
    const mutationOptions: MutationOptions<LinkResourcesResponse2, DefaultError, Options<LinkResourcesData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await linkResources({
                ...options,
                ...localOptions,
...
export const clientRealtimeWsQueryKey = (options?: Options<ClientRealtimeWsData>) => createQueryKey('clientRealtimeWs', options);

/**
 * Client realtime WebSocket
 * Upgrades to WebSocket for client realtime events. Auth TBD.
 */
export const clientRealtimeWsOptions = (options?: Options<ClientRealtimeWsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await clientRealtimeWs({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: clientRealtimeWsQueryKey(options)
    });
};
...
export const signUploadQueryKey = (options: Options<SignUploadData>) => createQueryKey('signUpload', options);

/**
 * Request a signed upload URL
 * Returns a URL (and optional form fields) to upload an attachment directly to storage.
 */
export const signUploadOptions = (options: Options<SignUploadData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: signUploadQueryKey(options)
    });
};
 ...
 * Returns a URL (and optional form fields) to upload an attachment directly to storage.
 */
export const signUploadMutation = (options?: Partial<Options<SignUploadData>>): MutationOptions<SignUploadResponse, DefaultError, Options<SignUploadData>> => {
    const mutationOptions: MutationOptions<SignUploadResponse, DefaultError, Options<SignUploadData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await signUpload({
                ...options,
                ...localOptions,
