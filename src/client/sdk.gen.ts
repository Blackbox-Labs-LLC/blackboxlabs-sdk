 ...
 */
export const getActionsCatalog = <ThrowOnError extends boolean = false>(options: Options<GetActionsCatalogData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetActionsCatalogResponses, unknown, ThrowOnError>({
 ...
 */
export const executeAction = <ThrowOnError extends boolean = false>(options: Options<ExecuteActionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ExecuteActionResponses, unknown, ThrowOnError>({
 ...
 */
export const linkResources = <ThrowOnError extends boolean = false>(options: Options<LinkResourcesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<LinkResourcesResponses, unknown, ThrowOnError>({
 ...
 */
export const clientRealtimeWs = <ThrowOnError extends boolean = false>(options?: Options<ClientRealtimeWsData, ThrowOnError>) => {
...
export const listResources = <ThrowOnError extends boolean = false>(options: Options<ListResourcesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ListResourcesResponses, unknown, ThrowOnError>({
 ...
 */
export const getTicketMessagesPublic = <ThrowOnError extends boolean = false>(options: Options<GetTicketMessagesPublicData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetTicketMessagesPublicResponses, GetTicketMessagesPublicErrors, ThrowOnError>({
...
export const signUpload = <ThrowOnError extends boolean = false>(options: Options<SignUploadData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SignUploadResponses, unknown, ThrowOnError>({
