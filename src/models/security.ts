...
export type Security = {
  blackboxAuthToken?: string | undefined;
};
...
export const Security$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  blackbox_auth_token: z.string().optional(),
}).transform((v) => {
  return remap$(v, {
    "blackbox_auth_token": "blackboxAuthToken",
  });
});

/** @internal */
export type Security$Outbound = {
  blackbox_auth_token?: string | undefined;
};
...
export const Security$outboundSchema: z.ZodType<
  ...
  Security
> = z.object({
  blackboxAuthToken: z.string().optional(),
}).transform((v) => {
  return remap$(v, {
    blackboxAuthToken: "blackbox_auth_token",
  });
});
