...
export interface Env {
  BLACKBOX_BLACKBOX_AUTH_TOKEN?: string | undefined;

  BLACKBOX_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  BLACKBOX_BLACKBOX_AUTH_TOKEN: z.string().optional(),

  BLACKBOX_DEBUG: z.coerce.boolean().optional(),
});
